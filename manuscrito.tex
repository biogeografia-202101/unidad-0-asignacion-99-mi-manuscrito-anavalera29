...
Para la realización de este estudio donde se determinó la abundacia y
agrupamiento de especie por medio de los datos del censo antes
mencionado, se utilizó el software de (R Core Team, 2019) donde se
cargaron varios paquetes de ecología numérica (Batlle, 2020) que
ayudaron a formar matriz de comunidad
