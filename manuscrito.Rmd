...
![matriz de comunidad normalizada\label{agrupado}](agrupamiento_metodos.png){width=100%}


![Representación de especies por abundancia de sitio\label{abundancia}](abndancia_especie.png){width=110%}


![Representación de especies por abundancia de sitio\label{homogeneidades}](diagrama_caja_especies.png){width=110%}

 
 Tabla de homogeneidad de promedios de variables ambientales\label{promedio}
