...
![matriz de comunidad normalizada\label{agrupado}](enlaces_metodos_diferentes.png){width=100%}

![Representación de especies por abundancia de sitio\label{abundancia}](especies.png){heinth=210%}

![Representación de especies por abundancia de sitio\label{homogeneidades}](Rplot01_diagrama_caja_agrpados.png){width=110%}
...
![\label{fig:soporte1} Mapa de asociación de especie con el elemento Zinc](mapa_zinc.png) {width=110%}
